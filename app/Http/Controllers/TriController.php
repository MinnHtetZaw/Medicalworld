...
// dd($transaction->toArray());
    ...
    return response()->json([
        ...
        // $accountId = Accounting::find('id'); // Replace with the account ID you want to query.
        //   return $this->sumofAmount();

        // $accountingData = Accounting::with(['transactions' => function ($query) {
