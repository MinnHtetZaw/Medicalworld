...
<div class="row">
    <div class="col-12">
          ...
          <div class="row justify-content-between">
            <label for="">Income Transaction List</label>

              {{-- <label cl/ass=""><span class="float-right">	 --}}
            <button type="button" data-toggle="modal" data-target="#add_incomes" class="btn btn-primary" onclick="hide_bank_acc()"><i class="fas fa-plus"></i> Add Income</button>
