...
<div class="row">
    <div class="col-12">
          ...
          <div class="row justify-content-between">
            <label class="mt-3">Transfer List</label>

             <span class="float-right">	<button type="button" data-toggle="modal" data-target="#add_transfer" class="btn btn-primary" onclick="hide_bank_acc()"><i class="fas fa-plus"></i> Transfer</button>
