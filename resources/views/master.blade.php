                        ...
                        @if (session()->get('user')->role == 'Owner' ||
                            ...
                            <li>
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    ...
                                    <li><a href="{{ route('category_list') }}">@lang('lang.category') @lang('lang.list')</a>
                                    </li>
                                    <li><a href="{{ route('subcategory_list') }}">@lang('lang.subcategory')
                                            @lang('lang.list')</a></li>
                                    <li><a href="{{ route('item_list') }}">Sales Product @lang('lang.list')</a></li>
                                    <li><a href="{{ route('factoryitem_list') }}">Factory Item @lang('lang.list')</a>
                                    </li>
                        ...
                        @if (session()->get('user')->role == 'Owner' ||
                            ...
                            <li>
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    ...
                                    <li><a href="{{ route('sale_panel') }}">@lang('lang.sales') @lang('lang.panel')</a>
                                    </li>
                                    ...
                                    @if (session()->get('user')->role == 'Owner')
                                        ...
                                        <li><a href="{{ route('saleCount', [$current_Date, $current_Date, 'sale']) }}">Item
                                                Sales Summary</a></li>
